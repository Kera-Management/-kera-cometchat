...
class CometChatGroupDetails extends _react.default.Component {
  ...
  render() {
    ...
    if (this.state.viewMember) {
      viewMembers = (0, _react2.jsx)(_Groups.CometChatViewGroupMemberList, {
    ...
    if (this.state.addMember) {
      addMembers = (0, _react2.jsx)(_Groups.CometChatAddGroupMemberList, {
    ...
    if (this.state.banMember) {
      bannedMembers = (0, _react2.jsx)(_Groups.CometChatBanGroupMemberList, {
        loggedinuser: this.state.loggedInUser,
    ...
    if (this.state.transferOwnership) {
      transferOwnership = (0, _react2.jsx)(_Groups.CometChatTransferOwnershipMemberList, {
        roles: this.roles,
        loggedinuser: this.state.loggedInUser,
        actionGenerated: this.membersActionHandler,
