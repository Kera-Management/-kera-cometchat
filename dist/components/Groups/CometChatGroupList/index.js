...
class CometChatGroupList extends _react.default.PureComponent {
  ...
  render() {
    ...
    const groups = this.state.grouplist.map(group => {
      ...
      return (0, _react2.jsx)(_Groups.CometChatGroupListItem, {
        key: group.guid,
        group: group,
    ...
    if (this.state.enableSearchGroup) {
      searchGroup = (0, _react2.jsx)("div", {
        ...
        css: (0, _style.groupSearchButtonStyle)(_search.default, this.getContext())
      }), (0, _react2.jsx)("input", {
        type: "text",
        autoComplete: "off",
    ...
    if (this.state.createGroup) {
      createGroup = (0, _react2.jsx)(_Groups.CometChatCreateGroup, {
