...
exports.CometChatSenderVideoMessageBubble = void 0;
...
class CometChatSenderVideoMessageBubble extends _react.default.Component {
  constructor(props) {
    super(props);
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (currentMessageStr !== nextMessageStr || this.state.isHovering !== nextState.isHovering || this.state.fileData !== nextState.fileData || this.state.thumbnailURL !== nextState.thumbnailURL) {
      return true;
    }
    return false;
  }
  ...
  render() {
    var _this$state$fileData, _this$state;
...
exports.CometChatSenderVideoMessageBubble = CometChatSenderVideoMessageBubble;
