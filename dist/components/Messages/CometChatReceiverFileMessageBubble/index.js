...
exports.CometChatReceiverFileMessageBubble = void 0;
...
class CometChatReceiverFileMessageBubble extends _react.default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (0, _react2.jsx)("div", {
      ...
      css: (0, _style.messageFileContainerStyle)(),
      className: "message__file__container"
    }, (0, _react2.jsx)("div", {
      css: (0, _style.messageFileWrapperStyle)(this.context),
    ...
    }), (0, _react2.jsx)("label", null, this.props.message.data.attachments[0].name)))), messageReactions, (0, _react2.jsx)("div", {
...
exports.CometChatReceiverFileMessageBubble = CometChatReceiverFileMessageBubble;
_defineProperty(CometChatReceiverFileMessageBubble, "contextType", _CometChatContext.CometChatContext);
