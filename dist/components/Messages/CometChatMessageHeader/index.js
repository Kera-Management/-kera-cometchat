...
class CometChatMessageHeader extends _react.default.Component {
  ...
  render() {
    ...
    const audioCallText = _translator.default.translate("AUDIO_CALL", this.context.language);
    let audioCallBtn = (0, _react2.jsx)("div", {
    ...
    if (this.context.checkIfCallIsOngoing()) {
      const audioCallText = _translator.default.translate("YOU_ALREADY_ONGOING_CALL", this.context.language);
      audioCallBtn = (0, _react2.jsx)("div", {
        className: audioCallClassName,
        css: (0, _style.chatOptionStyle)(_audioCall.default, this.context, 1),
        title: audioCallText
      }, (0, _react2.jsx)("i", null));
    }
    const videoCallText = _translator.default.translate("VIDEO_CALL", this.context.language);
    let videoCallBtn = (0, _react2.jsx)("div", {
    ...
    if (this.context.checkIfCallIsOngoing()) {
      const videoCallText = _translator.default.translate("YOU_ALREADY_ONGOING_CALL", this.context.language);
      videoCallBtn = (0, _react2.jsx)("div", {
        className: videoCallClassName,
