      ...
      if (message.hasOwnProperty("deletedAt")) {
        ...
        switch (message.type) {
          case _chat.CometChat.MESSAGE_TYPE.TEXT:
            ...
            break;
          case _chat.CometChat.MESSAGE_TYPE.IMAGE:
            component = message.data.attachments ? (0, _react2.jsx)(_.CometChatReceiverImageMessageBubble, {
              key: messageKey,
              message: message,
              actionGenerated: this.props.actionGenerated
            }) : null;
          ...
          case _chat.CometChat.MESSAGE_TYPE.FILE:
            ...
            break;
          case _chat.CometChat.MESSAGE_TYPE.AUDIO:
            component = message.data.attachments ? (0, _react2.jsx)(_.CometChatReceiverAudioMessageBubble, {
              key: messageKey,
              message: message,
              actionGenerated: this.props.actionGenerated
            }) : null;
            break;
          case _chat.CometChat.MESSAGE_TYPE.VIDEO:
            component = message.data.attachments ? (0, _react2.jsx)(_.CometChatReceiverVideoMessageBubble, {
              key: messageKey,
              message: message,
              actionGenerated: this.props.actionGenerated
            }) : null;
